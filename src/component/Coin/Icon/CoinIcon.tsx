...
function getIcon(type : string) {
    switch (type) {
        case 'platinum': return <PlatinumIcon></PlatinumIcon>
        case 'gold': return <GoldIcon></GoldIcon>
        case 'electrum': return <ElectrumIcon></ElectrumIcon>
        case 'silver': return <SilverIcon></SilverIcon>
        case 'copper': return <CopperIcon></CopperIcon>
    }
